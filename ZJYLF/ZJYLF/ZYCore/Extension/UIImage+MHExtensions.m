...
#import "UIImage+MHExtensions.h"

CGFloat MHDegreesToRadians(CGFloat degrees) {return degrees * M_PI / 180;};
CGFloat MHRadiansToDegrees(CGFloat radians) {return radians * 180/M_PI;};

@implementation UIImage (MHExtensions)
...
{
    return [self imageRotatedByDegrees:MHRadiansToDegrees(radians)];
}
...
- (UIImage *)imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation(MHDegreesToRadians(degrees));
    ...
    CGContextRotateCTM(bitmap, MHDegreesToRadians(degrees));

...
static const NSString * Block_key = @"block_assign";
@implementation UIView (Toast)

- (void)setBlock:(ShowMessageBlock)block
{
...
- (ShowMessageBlock)block
{
    id object = objc_getAssociatedObject(self, &Block_key);
